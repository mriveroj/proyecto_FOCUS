...
data <- data[!is.na(data$comentarios), ] # Removemos aquellas filas que tengan NAs
head(data$comentarios, 3)


##### Procedemos con el análisis de los textos #####

corpus_restaurantes <- Corpus(VectorSource(data$comentarios))
...
findAssocs(restaurantes_dtm, 'comida', 0.40)
